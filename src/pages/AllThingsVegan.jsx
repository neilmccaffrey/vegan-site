...
const AllThingsVegan = () => {
  ...
  return (
    <>
      <title>Friendly Vegan | Vegan resources</title>
      <meta name="description" content="Vegan resources and links." />
      <meta
        name="keywords"
        content="vegan, plant-based, restaurants, food, healthy eating, home, apparel"
      />
      {/* <link rel="canonical" href="https://yourdomain.com/allthingsvegan" /> */}
          ...
          <ul className="mt-10 mb-5 bg-gray-100 modal p-6 border rounded list-disc">
            <div className="flex flex-col">
              ...
              <span className="text-xs mb-5">
                A list of items that were not intentionally made to be vegan,
                but are a nice surprise.
              </span>
            </div>
            <li>Oreos</li>
